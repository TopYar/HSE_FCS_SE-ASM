...
<img src="https://raw.githubusercontent.com/TopYar/HSE_FCS_SE-ASM/master/HW2/img/proc4.png" alt="" width="700" /> <br><br>
...
Все отрицательные числа заменили на максимум (то есть 100), а неотрицательные числа остались нетронутыми
